      ...
      >
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 xl:px-12">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <motion.button
              onClick={() => window.open('https://wa.me/381641234567?text=Hi! I would like to place an order at Kombinat.', '_blank')}
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-t border-slate-700/50">
                  <motion.button
                    onClick={() => {
                      window.open('https://wa.me/381641234567?text=Hi! I would like to place an order at Kombinat.', '_blank');
